...
@Component({
  selector: 'app-alarm-management-realtime-alarm-list',
  templateUrl: './realtime-alarm-list.component.html',
})
export class AlarmManagementRealtimeAlarmListComponent implements OnInit {
  roleEnum = RoleEnum;
