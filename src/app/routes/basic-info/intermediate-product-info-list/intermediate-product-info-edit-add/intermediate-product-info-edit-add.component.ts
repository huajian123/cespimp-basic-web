...
@Component({
  selector: 'app-basic-info-intermediate-product-info-edit-add',
  templateUrl: './intermediate-product-info-edit-add.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class BasicInfoIntermediateProductInfoEditAddComponent implements OnInit {
  ...
  async submit() {
    ...
    if (!this.id) {
      params.productType = ProductEnum.MidPro;//所属中间产品一类
