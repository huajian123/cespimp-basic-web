...
@Component({
  selector: 'app-basic-info-final-product-info-list',
  templateUrl: './final-product-info-list.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class BasicInfoFinalProductInfoListComponent implements OnInit {
  ...
  async getDataList(pageNumber?: number) {
    ...
    const params:EntprProductSearchModel = {
      productType: ProductEnum.FinalPro,
