...
@Component({
  selector: 'app-special-operation-management-hoisting-operation-edit-add',
  templateUrl: './hoisting-operation-edit-add.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SpecialOperationManagementHoistingOperationEditAddComponent implements OnInit {
  uploadUrl: string;
  showUploadList = {
  ...
  async submit() {
    ...
    params.operationType = SpecialInfoEnum.HoistingOperation;
