...
@Component({
  selector: 'app-special-operation-management-hoisting-operation-detail',
  templateUrl: './hoisting-operation-detail.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SpecialOperationManagementHoistingOperationDetailComponent implements OnInit {
