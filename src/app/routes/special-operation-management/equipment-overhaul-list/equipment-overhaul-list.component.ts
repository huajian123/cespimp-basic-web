...
@Component({
  ...
  templateUrl: './equipment-overhaul-list.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SpecialOperationManagementEquipmentOverhaulListComponent implements OnInit {
  roleEnum = RoleEnum;
  isVisible = false;
  ...
  async getDataList(pageNumber?: number) {
    ...
    const params: SpecialOperationEnumModel = {
      operationType: SpecialInfoEnum.EquipmentOverhaul,
