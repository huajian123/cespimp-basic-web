...
@Component({
  selector: 'app-special-operation-management-equipment-overhaul-edit-add',
  templateUrl: './equipment-overhaul-edit-add.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SpecialOperationManagementEquipmentOverhaulEditAddComponent implements OnInit {
  uploadUrl: string;
  showUploadList = {
  ...
  async submit() {
    ...
    params.operationType = SpecialInfoEnum.EquipmentOverhaul;
