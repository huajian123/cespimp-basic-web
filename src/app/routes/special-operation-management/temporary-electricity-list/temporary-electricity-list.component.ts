...
@Component({
  ...
  templateUrl: './temporary-electricity-list.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SpecialOperationManagementTemporaryElectricityListComponent implements OnInit {
  roleEnum = RoleEnum;
  isVisible = false;
  ...
  async getDataList(pageNumber?: number) {
    const params: SpecialOperationEnumModel = {
      operationType: SpecialInfoEnum.TemporaryElectricity,
