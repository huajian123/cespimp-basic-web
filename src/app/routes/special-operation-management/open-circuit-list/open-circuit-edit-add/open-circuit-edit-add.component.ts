...
@Component({
  selector: 'app-special-operation-management-open-circuit-edit-add',
  templateUrl: './open-circuit-edit-add.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SpecialOperationManagementOpenCircuitEditAddComponent implements OnInit {
  uploadUrl: string;
  showUploadList = {
  ...
  async submit() {
    ...
    params.operationType = SpecialInfoEnum.OpenCircuit;
