...
@Component({
  selector: 'app-special-operation-management-earth-moving-detail',
  templateUrl: './earth-moving-detail.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SpecialOperationManagementEarthMovingDetailComponent implements OnInit {
