...
@Component({
  selector: 'app-special-operation-management-earth-moving-edit-add',
  templateUrl: './earth-moving-edit-add.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SpecialOperationManagementEarthMovingEditAddComponent implements OnInit {
  uploadUrl: string;
  showUploadList = {
  ...
  async submit() {
    ...
    params.operationType = SpecialInfoEnum.EarthMoving;
