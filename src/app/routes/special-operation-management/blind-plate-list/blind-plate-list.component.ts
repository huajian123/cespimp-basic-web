...
@Component({
  selector: 'app-special-operation-management-blind-plate-list',
  templateUrl: './blind-plate-list.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SpecialOperationManagementBlindPlateListComponent implements OnInit {
  roleEnum = RoleEnum;
  ...
  async getDataList(currentType = SpecialInfoEnum.BlindPlate) {
    const params = {
