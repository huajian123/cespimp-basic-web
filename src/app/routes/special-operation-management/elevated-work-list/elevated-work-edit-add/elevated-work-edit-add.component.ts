...
@Component({
  selector: 'app-special-operation-management-elevated-work-edit-add',
  templateUrl: './elevated-work-edit-add.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SpecialOperationManagementElevatedWorkEditAddComponent implements OnInit {
  uploadUrl: string;
  showUploadList = {
  ...
  async submit() {
    ...
    params.operationType = SpecialInfoEnum.ElevatedWork;
