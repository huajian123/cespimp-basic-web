...
export namespace HazardousChemicalListServiceNs {
  ...
  export interface HazardousChemicalSearchModel {
    entprName?: string;
    productName?: string;
  }
  ...
  export class HazardousChemicalInfoServiceClass {
    ...
    /*查询列表*/
    public getHazardousChemicalList(param: SearchCommonVO & HazardousChemicalSearchModel): Promise<PageInfo<HazardousChemicalInfoModel>> {
